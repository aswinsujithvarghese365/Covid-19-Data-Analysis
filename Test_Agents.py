    ...
    if(x=="ACCESS GRANTED"):
        while True:
            ...
            if(th=='1'):
                ...
                print()
                if(ed=='1'):
                    # Entering details of the patient
                    #Entering patient's name
                    p_name=input("ENTER PATIENT'S NAME: ")
                    p_name=p_name.upper()
                    #Entering patient's email
                    ...
                    # inserting the details into patients table
                    ...
                    for ab in mycursor:
                        if(ab==(1,)):
                            # Editing details of the patient
                    ...
                    # Entering test result of the patient only if the Test agent is from mobile unit
                    for mu in mycursor:
